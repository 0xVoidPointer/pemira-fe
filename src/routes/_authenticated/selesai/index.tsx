...
function RouteComponent() {
	...
	return (
		<div className="flex min-h-dvh items-center justify-center p-4 animate-fade animate-once animate-ease-in-out animate-normal animate-fill-forwards motion-reduce:animate-none">
